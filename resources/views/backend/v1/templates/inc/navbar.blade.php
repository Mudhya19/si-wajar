            ...
            <div class="container-fluid border-bottom px-4">
                <button class="header-toggler" type="button"
                    ...
                    <svg class="icon icon-lg">
                        <use
                            xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-menu">
                        </use>
                    </svg>
                </button>
                ...
                <ul class="header-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            <svg class="icon icon-lg">
                                <use
                                    xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-bell">
                                </use>
                            </svg></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            <svg class="icon icon-lg">
                                <use
                                    xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-list-rich">
                                </use>
                            </svg></a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="#">
                            <svg class="icon icon-lg">
                                <use
                                    xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-envelope-open">
                                </use>
                            </svg></a>
                    </li>
                </ul>
                    ...
                    <li class="nav-item dropdown">
                        <button class="btn btn-link nav-link py-2 px-2 d-flex align-items-center" type="button"
                            ...
                            <svg class="icon icon-lg theme-icon-active">
                                <use
                                    xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-contrast">
                                </use>
                            </svg>
                        </button>
                        <ul class="dropdown-menu dropdown-menu-end" style="--cui-dropdown-min-width: 8rem;">
                            <li>
                                <button class="dropdown-item d-flex align-items-center" type="button"
                                    ...
                                    <svg class="icon icon-lg me-3">
                                        <use
                                            xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-sun">
                                        </use>
                                    </svg>Light
                                </button>
                            </li>
                            <li>
                                <button class="dropdown-item d-flex align-items-center" type="button"
                                    ...
                                    <svg class="icon icon-lg me-3">
                                        <use
                                            xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-moon">
                                        </use>
                                    </svg>Dark
                                </button>
                            </li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end pt-0">
                            ...
                            <a class="dropdown-item" href="#">
                                <svg class="icon me-2">
                                    <use
                                        xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-task">
                                    </use>
                                </svg> Tasks<span class="badge badge-sm bg-danger ms-2">42</span></a>
                            <a class="dropdown-item" href="#">
                                <svg class="icon me-2">
                                    <use
                                        xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-comment-square">
                                    </use>
                            ...
                            <a class="dropdown-item" href="#">
                                <svg class="icon me-2">
                                    <use
                                        xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-user">
                                    </use>
                                </svg> Profile</a>
                            <a class="dropdown-item" href="#">
                                <svg class="icon me-2">
                            ...
                            <a class="dropdown-item" href="#">
                                <svg class="icon me-2">
                                    <use
                                        xlink:href="{{ url('templates/backend') }}/node_modules/@coreui/icons/sprites/free.svg#cil-file">
                                    </use>
